...
class Optimizer:
    ...
    @progress_bar_decorator(total_steps=100, description="Solving")
    def solve(self, pbar, problem: Union[Dict, Problem] = None, mode: str = 'single', n_workers: int = None,
